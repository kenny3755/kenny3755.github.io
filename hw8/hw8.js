/*--------------------------------------------------------------------------------
hw8.js (modified from 20_DirectionalLight.js)
...
let shadingMode = 'SMOOTH';     // 'FLAT' or 'SMOOTH' (Homework 8 requires SMOOTH)
let toonLevels = 3;             // Toon Shading 레벨 (기본 3)
...
function setupKeyboardEvents() {
    document.addEventListener('keydown', (event) => {
        ...
        // 's' and 'f' keys are removed as per homework spec (always smooth shading)
...
function render() {
    ...
    shader.setInt("u_toonLevels", toonLevels); // Toon Level 유니폼 업데이트
...
async function main() {
    try {
        ...
        // Set to smooth shading as required
        ...
        shader.setVec3("material.diffuse", vec3.fromValues(0.9, 0.45, 0.1)); 
        ...
        // Update text overlays to match homework video/requirements
        ...
        // Original text lines 6 and 7 ('s' and 'f') are removed.
